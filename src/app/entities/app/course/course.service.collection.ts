...
export class CourseServiceCollection extends ServiceCollection<Course> implements IServiceCollection<Course> {
  ...
  constructor() {
    super(inject(API_Operation<Course>));
  }

  //#region CollectionMethods

  CollectionOfStudentCourse(course_id: number, studentCourse: StudentCourse = StudentCourseBuilder.BuildSeekInstance()): Observable<StudentCourse[]> {
